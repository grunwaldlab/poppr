...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: no item called "{}package:poppr"{} on the search list}}\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.933, 0.933, 0.933}\color{fgcolor}\begin{kframe}
\begin{verbatim}
getfile(multi = FALSE, pattern = combine = TRUE)
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.933, 0.933, 0.933}\color{fgcolor}\begin{kframe}
\begin{verbatim}
read.genalex(genalex, ploidy = 2, geo = FALSE, region = FALSE, genclone = TRUE)
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.933, 0.933, 0.933}\color{fgcolor}\begin{kframe}
\begin{verbatim}
genind2genalex(pop, filename = genalex.csv, quiet = FALSE, geo = FALSE, geodf = xy)
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.933, 0.933, 0.933}\color{fgcolor}\begin{kframe}
\begin{verbatim}
splitcombine(pop, method = 1)dfname = population_hierarchy, sep = _, hier = c,  hier = 1, setpopulation = TRUE)fixed = TRUE)
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.933, 0.933, 0.933}\color{fgcolor}\begin{kframe}
\begin{verbatim}
popsub(pop, sublist = ALL, blacklist = mat = drop = TRUE)
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.933, 0.933, 0.933}\color{fgcolor}\begin{kframe}
\begin{verbatim}
clonecorrect(pop, hier = c,  hier = 1, dfname = population_hierarchy, combine = FALSE, keep = 1)
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.933, 0.933, 0.933}\color{fgcolor}\begin{kframe}
\begin{verbatim}
informloci(pop, cutoff = /,  cutoff = 2,  cutoff = nInd(pop), quiet = FALSE)
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.933, 0.933, 0.933}\color{fgcolor}\begin{kframe}
\begin{verbatim}
mlg.crosspop(pop, sublist = ALL, blacklist = mlgsub = indexreturn = FALSE)df = FALSE)quiet = FALSE)
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.933, 0.933, 0.933}\color{fgcolor}\begin{kframe}
\begin{verbatim}
mlg.table(pop, sublist = ALL, blacklist = mlgsub = bar = TRUE, total = FALSE)quiet = FALSE)
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.933, 0.933, 0.933}\color{fgcolor}\begin{kframe}
\begin{verbatim}
bruvo.boot(pop, replen = 1, add = TRUE, loss = TRUE, sample = 100, tree = upgma, showtree = TRUE, cutoff = quiet = FALSE, ..., 
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.933, 0.933, 0.933}\color{fgcolor}\begin{kframe}
\begin{verbatim}
greycurve(glim = c,  glim = 0,  glim = 0.8, gadj = 3, gweight = 1)
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.933, 0.933, 0.933}\color{fgcolor}\begin{kframe}
\begin{verbatim}
bruvo.msn(pop, replen = 1, add = TRUE, loss = TRUE, palette = topo.colors, sublist = All, blacklist = vertex.label = MLG, gscale = TRUE, glim = c,  glim = 0,  glim = 0.8, gadj = 3, gweight = 1, wscale = TRUE, ..., 
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.933, 0.933, 0.933}\color{fgcolor}\begin{kframe}
\begin{verbatim}
poppr.msn(pop, distmat, palette = topo.colors, sublist = All, blacklist = vertex.label = MLG, gscale = TRUE, glim = c,  glim = 0,  glim = 0.8, gadj = 3, gweight = 1, wscale = TRUE, ..., 
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.933, 0.933, 0.933}\color{fgcolor}\begin{kframe}
\begin{verbatim}
poppr(pop, total = TRUE, sublist = c,  sublist = ALL, blacklist = c,  blacklist = NULL, sample = 0, method = 1, missing = ignore, cutoff = 0.05, quiet = FALSE, clonecorrect = FALSE, hier = c,  hier = 1, dfname = population_hierarchy, keep = 1, hist = TRUE, minsamp = 10)
\end{verbatim}
\end{kframe}
\end{knitrout}
