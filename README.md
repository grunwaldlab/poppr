...
In development:    
[![Build Status](https://travis-ci.org/grunwaldlab/poppr.svg?branch=rraf-options)](https://travis-ci.org/grunwaldlab/poppr)
[![Coverage Status](https://coveralls.io/repos/grunwaldlab/poppr/badge.svg?branch=rraf-options)](https://coveralls.io/r/grunwaldlab/poppr?branch=rraf-options)
