...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: length of 'dimnames' [2] not equal to array extent}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'sim\_ex' not found}}\end{kframe}
\end{knitrout}
