...
\definecolor{shadecolor}{rgb}{0.933, 0.933, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{poppr.all}\hlstd{(x}\hlopt{$}\hlstd{files)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##          Pop   N MLG  eMLG    SE     H     G  Hexp   E.5     Ia rbarD        File
## 1     Athena  97  70 65.98 1.246 4.063 42.19 0.986 0.721  2.906 0.072 rootrot.csv
## 2 Mt. Vernon  90  50 50.00 0.000 3.668 28.72 0.976 0.726 13.302 0.282 rootrot.csv
## 3      Total 187 119 68.45 2.989 4.558 68.97 0.991 0.720 14.371 0.271 rootrot.csv
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##          Pop   N MLG  eMLG    SE     H     G  Hexp   E.5     Ia rbarD        File
## 1     Athena  76  70 60.62 1.017 4.221 65.64 0.998 0.963  2.535 0.062 rootrot.csv
## 2 Mt. Vernon  65  50 50.00 0.000 3.796 36.74 0.988 0.821 14.310 0.298 rootrot.csv
## 3      Total 141 119 59.63 1.854 4.705 96.98 0.997 0.876 13.802 0.260 rootrot.csv
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\end{verbatim}
\begin{alltt}
\hlkwd{replicate}\hlstd{(}\hlnum{10}\hlstd{,} \hlkwd{ia}\hlstd{(}\hlkwd{shufflepop}\hlstd{(nan1,} \hlkwc{method} \hlstd{=} \hlnum{2}\hlstd{),} \hlkwc{quiet} \hlstd{=} \hlnum{TRUE}\hlstd{))}
\end{alltt}
\begin{verbatim}
##           [,1]     [,2]     [,3]     [,4]     [,5]     [,6]    [,7]     [,8]     [,9]
## Ia    -0.35202 0.057744 0.032000 -0.37774 -0.21588 -0.25668 0.25675 -0.28758 -0.10313
## rbarD -0.04475 0.007344 0.004057 -0.04803 -0.02752 -0.03299 0.03244 -0.03682 -0.01306
##           [,10]
## Ia    -0.071846
## rbarD -0.009271
\end{verbatim}
...
\hlstd{H.sub} \hlkwb{<-} \hlstd{H3N2[H.vec} \hlopt{%in%} \hlstd{UGNN, ]}
...
\hlstd{H.df[H.vec} \hlopt{%in%} \hlstd{UGNN,} \hlnum{1}\hlopt{:}\hlnum{15}\hlstd{]}  \hlcom{# Showing only 15 columns becaus it is a large dataset.}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\end{verbatim}
\begin{alltt}
\hlstd{H.vec[H.vec} \hlopt{%in%} \hlstd{UGNN]}
\end{alltt}
\begin{verbatim}
##  [1] 620 620 620 620 620 620 620 620 620 620 317 315 315 317 317 315 317 315 315 315 315
## [22] 317
...
\hlstd{df[df}\hlopt{$}\hlstd{MLG} \hlopt{%in%} \hlstd{H.max[}\hlnum{1}\hlstd{], ]}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.933, 0.933, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{df2} \hlkwb{<-} \hlstd{df[df}\hlopt{$}\hlstd{MLG} \hlopt{%in%} \hlstd{H.max, ]}
...
## 1     Athena  97  70 65.98 1.246 4.063 42.19 0.986 0.721  2.906 0.001 0.072 0.001
## 2 Mt. Vernon  90  50 50.00 0.000 3.668 28.72 0.976 0.726 13.302 0.001 0.282 0.001
## 3      Total 187 119 68.45 2.989 4.558 68.97 0.991 0.720 14.371 0.001 0.271 0.001
##          File
## 1 rootrot.csv
## 2 rootrot.csv
## 3 rootrot.csv
...
\begin{verbatim}
##          Pop   N MLG  eMLG    SE     H     G  Hexp   E.5     Ia  p.Ia rbarD  p.rD
## 1     Athena  76  70 60.62 1.017 4.221 65.64 0.998 0.963  2.535 0.001 0.062 0.001
## 2 Mt. Vernon  65  50 50.00 0.000 3.796 36.74 0.988 0.821 14.310 0.001 0.298 0.001
## 3      Total 141 119 59.63 1.854 4.705 96.98 0.997 0.876 13.802 0.001 0.260 0.001
##          File
## 1 rootrot.csv
## 2 rootrot.csv
## 3 rootrot.csv
...
\begin{verbatim}
##          Pop   N MLG  eMLG    SE     H   G Hexp   E.5     Ia  p.Ia rbarD  p.rD
## 1     Athena  70  70 50.00 0.000 4.248  70    1 1.000  2.438 0.001 0.060 0.001
## 2 Mt. Vernon  50  50 50.00 0.000 3.912  50    1 1.000 13.856 0.001 0.285 0.001
## 3      Total 120 119 49.83 0.377 4.776 118    1 0.995 12.497 0.001 0.234 0.001
##          File
## 1 rootrot.csv
## 2 rootrot.csv
## 3 rootrot.csv
...
## 1   5 15  15   11  0 2.708 15    1   1 -0.048 0.576 -0.006 0.576 truenames(nancycats)$tab
## 2   6 11  11   11  0 2.398 11    1   1  0.334 0.070  0.043 0.071 truenames(nancycats)$tab
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\texttt{shufflepop} & Shuffles genotypes at each locus using four different shuffling algorithms \\
...
\texttt{mlg.vector} & Returns a vector of a numeric multilocus genotype assignment for \\ 
 & each individual \\
...
% \begin{itemize}
% \item print_command("getfile") (Section \ref{intro:import:getfile})
% \item print_command("read.genalex") (Section \ref{intro:import:read.genalex}) 
% \item print_command("genind2genalex") (Section \ref{intro:import:genind2genalex})
% \item print_command("missingno") (Section \ref{data.manip:missing:missingno})
% \item print_command("splitcombine") (Section \ref{data.manip:hier:splitcombine})
% \item print_command("popsub") (Section \ref{data.manip:divide:popsub})
% \item print_command("clonecorrect") (Section \ref{data.manip:cc:clonecorrect})
% \item print_command("shufflepop") (Section \ref{data.manip:shuffle:shufflepop})
% \item print_command("informloci") (Section \ref{data.manip:informloci})
% \item print_command("mlg") (Section \ref{mlg:mlg:mlg})
% \item print_command("mlg.crosspop") (Section \ref{mlg:cross:mlg.crosspop})
% \item print_command("mlg.table") (Section \ref{mlg:table:mlg.table})
% \item print_command("mlg.vector") (Section \ref{mlg:mix:mlg.vector})
% \item print_command("ia") (Section \ref{index:iard:ia})
% \item print_command("diss.dist") (Section \ref{index:dist:diss.dist})
% \item print_command("bruvo.dist") (Section \ref{index:bruvo:bruvo.dist})
% \item print_command("bruvo.boot") (Section \ref{index:trees:bruvo.boot})
% \item print_command("greycurve") (Section \ref{index:trees:greycurve})
% \item print_command("bruvo.msn") (Section \ref{index:trees:bruvo.msn})
% \item print_command("poppr.msn") (Section \ref{index:trees:poppr.msn})
% \item print_command("poppr") (Section \ref{summary:poppr})
% \item print_command("poppr.all") (Sections \ref{intro:import:getfile} and \ref{summary:poppr})
