...
"4", "Total"), class = "factor"),
    ...
    Hexp = c(0.961538461538461, 0.987179487179487, 0.984848484848485, 0.939393939393939, 0.963265306122449), 
...
test_that("poppr returns expected PA values", { 
  ...
  expect_that(A.tab$Hexp, equals(Aeut_comparison$Hexp))
...
test_that("poppr returns expected codominant values", {
  ...
  expect_that(p.tab$Hexp, equals(pc_comparison$Hexp))
