...
If you use *poppr* in a presentation pelase mention it as the *poppr* R pacakge and use our [logo](http://grunwaldlab.cgrb.oregonstate.edu/sites/default/files/u5/poppr_test.png).
