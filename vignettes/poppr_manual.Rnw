...
set.seed(9999)
bd.test <- replicate(100, mean(bruvo.dist(shufflepop(nan1, method = 2), replen = rep(2, 9))))
@
...
<<bd_histogram>>=
hist(bd.test, xlab = "Bruvo's Distance", main = "Average Bruvo's distance over 100 randomizations")
