...
\title{Algorithms and equations utilized in poppr version 1.1.5.99.583}
...
equivalent to Kronecker's delta as presented in \citep{excoffier1992analysis}. As
...
% \poppr{} as it was previously in \textit{multilocus} \citep{Agapow:2001}. The
