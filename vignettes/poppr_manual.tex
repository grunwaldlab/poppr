...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error: values must be length 1,\\ but FUN(X[[5]]) result is length 2}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error: values must be length 1,\\ but FUN(X[[2]]) result is length 2}}\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.933, 0.933, 0.933}\color{fgcolor}\begin{kframe}
\begin{verbatim}
mlg.table(pop, sublist = "ALL", blacklist = NULL, mlgsub = NULL, bar = TRUE, 
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error: values must be length 1,\\ but FUN(X[[3]]) result is length 2}}\end{kframe}
\end{knitrout}
