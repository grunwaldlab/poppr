...
<https://grunwaldlab.github.io/Population_Genetics_in_R/> and the source code can
...
the *poppr* forum at <https://groups.google.com/d/forum/poppr>. You can submit bug
...
published in the journal **PeerJ**: <https://peerj.com/articles/281/>
[@kamvar2014poppr]. The new features in version 2.0 were published in
**Frontiers** <https://doi.org/10.3389/fgene.2015.00208>
[@kamvar2015novel].
...
the Rstudio IDE (<https://www.rstudio.com/>), which allows the user to
...
user to use Rstudio <https://www.rstudio.com/>.
...
-   Bitmap based editors (for jpeg, bmp, png, etc...)
    ...
    -   **The GIMP**
        Free, cross-platform. <https://www.gimp.org>
    -   **Paint.net** Free,
        Windows only. <https://www.getpaint.net>
    -   **Adobe Photoshop**
